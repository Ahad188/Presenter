                   ...
                   <div className="card md:w-1/2 max-w-sm shadow-2xl bg-base-100">
                       <form onSubmit={handleLogin} className="card-body">
                           ...
                           <div className="form-control">
                               ...
                               <input   type="text" name="captcha" placeholder="type the captcha above" className="input input-bordered w-80" />
                       ...
                       <p className="text-center text-2xl"><small>New Here? <Link to="/register">Create an account</Link> </small></p>
