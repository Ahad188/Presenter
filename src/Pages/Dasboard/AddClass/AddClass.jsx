    ...
    formData.append('image', data.image[0])
          ...
          .then(resImage=>{
               ...
               if(resImage.success){
                    ...
                    const newClass ={teacherName,subject,studentCount:parseFloat(studentCount),sit:parseFloat(sit),price:parseFloat(price),description, image:imgURL}
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="w-[450px] mx-auto border border-[#2e9cf0] border-r-8 border-b-8 p-10 my-20">
          ...
          <div className="form-control w-full max-w-xs">
            ...
            <textarea className="textarea textarea-info" {...register("description")} placeholder="Description"></textarea>
          </div>
          ...
          <div className="form-control w-full max-w-xs">
            ...
            <input type="file" {...register("image")} className="file-input file-input-bordered file-input-info w-full max-w-xs" />
          </div>
